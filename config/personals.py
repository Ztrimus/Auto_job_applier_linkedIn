...
# Your legal name
first_name = "Saurabh"  # Your first name in quotes Eg: "First", "Sai"
middle_name = "Bhausaheb"  # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Zinjad"  # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "4809135544"  # Enter your 10 digit number in quotes Eg: "9876543210"
