...
# search_location = ["San Francisco", "San Jose", "Austin", "Seattle", "Pittsburgh", "San Diego", "Boston", "Atlanta", "United States"]  # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
